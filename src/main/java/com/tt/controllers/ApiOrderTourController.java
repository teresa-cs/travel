...
public class ApiOrderTourController {
    ...
    @PostMapping(path = "/api/ordertour", produces = {
        ...
        try {
            ...
            if(params.get("iddiscount")!=null){
                Integer iddiscount = Integer.parseInt(params.get("iddiscount"));
                 o = this.orderTourService.addOrderTour(fullname, gmail, phone, adult, children, total, iddiscount);
            }else{
                o = this.orderTourService.addOrderTour(fullname, gmail, phone, adult, children, total);
            }
