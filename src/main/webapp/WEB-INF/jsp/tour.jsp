                            ...
                            <div class="col-md-9">
                                    <div class="row">
                                            <div class="wrap-division">
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    ...
                                                                    <span class="desc">
                                                                            ...
                                                                            <h2><a href="tour/tour-place">Family Tour in Greece</a></h2>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    <a href="tour/tour-place" class="tour-img" style="background-image: url(template/images/tour-2.jpg);">
                                                                            <p class="price"><span>$1500</span> <small>/ 3 Days</small></p>
                                                                    </a>
                                                                    <span class="desc">
                                                                            <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    <a href="tour/tour-place" class="tour-img" style="background-image: url(template/images/tour-3.jpg);">
                                                                            <p class="price"><span>$1500</span> <small>/ 3 Days</small></p>
                                                                    </a>
                                                                    <span class="desc">
                                                                            <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    <a href="tour/tour-place" class="tour-img" style="background-image: url(template/images/tour-4.jpg);">
                                                                            <p class="price"><span>$1500</span> <small>/ 3 Days</small></p>
                                                                    </a>
                                                                    <span class="desc">
                                                                            <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    <a href="tour/tour-place" class="tour-img" style="background-image: url(template/images/tour-5.jpg);">
                                                                            <p class="price"><span>$1500</span> <small>/ 3 Days</small></p>
                                                                    </a>
                                                                    <span class="desc">
                                                                            <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    <a href="tour/tour-place" class="tour-img" style="background-image: url(template/images/tour-6.jpg);">
                                                                            <p class="price"><span>$1500</span> <small>/ 3 Days</small></p>
                                                                    </a>
                                                                    <span class="desc">
                                                                            <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    <a href="tour/tour-place" class="tour-img" style="background-image: url(template/images/tour-7.jpg);">
                                                                            <p class="price"><span>$1500</span> <small>/ 3 Days</small></p>
                                                                    </a>
                                                                    <span class="desc">
                                                                            <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 animate-box">
                                                            <div class="tour">
                                                                    <a href="tour/tour-place" class="tour-img" style="background-image: url(template/images/tour-8.jpg);">
                                                                            <p class="price"><span>$1500</span> <small>/ 3 Days</small></p>
                                                                    </a>
                                                                    <span class="desc">
                                                                            <p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
